...
STARTING_HEALTH = 70
STARTING_DECK = [cardsFile.FiendFire(), cardsFile.Inflame(), cardsFile.Inflame(), cardsFile.Pummel(), cardsFile.Pummel(),
                 cardsFile.Defend(), cardsFile.Defend(), cardsFile.Defend(), cardsFile.Defend(), cardsFile.Bash()]
